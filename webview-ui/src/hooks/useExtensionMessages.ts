    ...
    const handler = (msg: any) => {
      ...
      if (msg.type === 'layoutLoaded') {
        ...
        for (const p of pendingAgents) {
          ...
          os.setAgentIdentity(p.id, p.identity);
        }
        pendingAgents = [];
        ...
        const identity = {
          ...
          agentKey: msg.agentKey as string | undefined,
        ...
        os.setAgentIdentity(id, identity);
        saveAgentSeats(os);
        ...
        const identities = (msg.identities || {}) as Record<
          number,
          {
            providerId?: string;
            agentKey?: string;
      ...
      } else if (msg.type === 'agentIdentityInfo') {
        os.setAgentIdentity(msg.id as number, {
          providerId: msg.providerId as string | undefined,
          agentKey: msg.agentKey as string | undefined,
          displayName: msg.displayName as string | undefined,
          role: msg.role as string | undefined,
