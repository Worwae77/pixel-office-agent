...
import { claudeProvider, copyHookScript, createProviderRegistry } from '../../server/src/providers/index.js';
...
export class PixelAgentsViewProvider implements vscode.WebviewViewProvider {
  ...
  constructor(
    ...
    this.runtime = new AgentRuntime(this.store, createProviderRegistry());
  ...
  private initServer(): void {
    ...
    this.pixelAgentsServer
      .start({ store: this.store, runtime: this.runtime, embedded: true })
      .then((config) => {
