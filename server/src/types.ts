...
export interface AgentState {
  ...
  providerId?: string;
  /** Stable roster identity, independent from a runtime session ID. */
  agentKey?: string;
  /** User-facing roster name. */
  displayName?: string;
  /** Persistent office role (for example, Software Engineer). */
  role?: string;
  /** Configured model/backend label. */
  model?: string;
